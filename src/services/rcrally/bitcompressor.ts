...
export function compressObjectives(objectives: Record<string, number> | undefined): string {
...
export function compressParts(parts: Record<string, number> | undefined): string {
